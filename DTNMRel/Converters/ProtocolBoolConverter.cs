...
{
    public class ProtocolBoolConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            if (value is CommunicationProtocol protocol)
            {
                return (protocol == CommunicationProtocol.TCP) ||
                    (protocol == CommunicationProtocol.UDP);
            }
            return value;
        }
