...
{
    public class ReplaceFilter : ITwoStringFilter
    {
        ...
        public byte[] FilterInput(byte[] input, Encoding enc)
        {
            ...
            byte[] p2 = enc.GetBytes(ICF.ReplaceSpecialCharacters(ICF.ReplaceVariables(Param2)));

            return ArrayHelper.ReplaceAllArrays(input, p1, p2);
        }
